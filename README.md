...
**Project**: tripster-haven 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Build an airbnb clone with landing page booking page and my trips page 
...
```sh
git clone https://github.com/GPT-Engineer-App/tripster-haven.git
cd tripster-haven
npm i
