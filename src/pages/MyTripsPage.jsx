...
const TripCard = ({ image, title, dates, isPast }) => (
  <div className="bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div className="p-4">
      ...
      <p className="text-gray-700 mb-4">{dates}</p>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4 text-gray-900">Upcoming Trips</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 text-gray-900">Past Trips</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pastTrips.map((trip) => (
